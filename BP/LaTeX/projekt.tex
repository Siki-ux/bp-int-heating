...
\documentclass[zadani,slovak,cprint]{fitthesis} % odevzdani do wisu a/nebo tisk s barevnými odkazy - odkazy jsou barevné
...
\projectinfo{
  ...
  declaration={Prehlasujem, že som túto bakalársku prácu vypracoval samostatne pod vedením pána Ing.~Jiřího Hynka, Ph.D.
Ďalšie informácie mi poskytli Ing.~Michal~Valný,~Ph.D. a Ing.~František~Mikulu, vývojári firmy Logimic a Ing.~Slavomír Satvár z firmy Virtuálny správca budov. 
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Týmto by som chcel poďakovať Ing. Jiřímu Hynkovi, Ph.D, za odborné vedenie mojej práce, konzultácie, rady a hlavne trpezlivosť a ochotu. Ďalej by som chcel poďakovať vývojárom firmy Logimic Ing. Michalovi Valnému, Ph.D. a Ing. Františkovi Mikulu za poskytnutie zariadení a ďalších prostriedkov pre vývoj, ako aj cenných rád pri implementácii. V neposlednej rade, by som chcel poďakovať Ing. Slavomírovi Satvárovi za rozhovor a poskytnuté informácie, rovnako ako aj všetkým anonymným respondentom.},
...
\begin{document}
  ...
  \input{content-IOT.tex}
  \input{content-Problematika-kurenia.tex}
  \input{content-Analyza.tex}
  \input{content-Navrh.tex}
  \input{content-Implementacia.tex}
  \input{content-Testovanie.tex}
  \input{content-Zaver.tex}
