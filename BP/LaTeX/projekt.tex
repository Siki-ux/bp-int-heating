...
\projectinfo{
  ...
  abstract.en={The goal of this bachelor's thesis was to design and implement a central heating regulation system with a focus on the~regulation of individual rooms. This system should be remotely controlled by the Logimic Smart City platform and should automatically regulate the~heating in an adaptive way. This method should bring significant savings to households equipped with such a system. This solution should differ from existing solutions mainly in~that we enter desired room temperature to the system and the system will control the~heating elements to reach and maintain the desired room temperature.}, % abstrakt v anglickém jazyce / abstract in english
